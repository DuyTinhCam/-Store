        ...
        <div class="card alert">
            <div class="card-body">
                <div class="table-responsive" style="border: none;">
                    ...
                    <br>
                    <img src="https://api.vietqr.io/image/vietinbank-<?php echo $setting[0]['SoTaiKhoan'] ?>-fTpTJka.jpg?accountName=<?php echo $setting[0]['ChuTaiKhoan'] ?>&amount=<?php echo $_SESSION['sumMenu']; ?>&addInfo=<?php echo $_SESSION['noidung']; ?>" style="display: block; margin-left: auto; margin-right: auto; width: 100%; height: 100%;">
                    <hr>
